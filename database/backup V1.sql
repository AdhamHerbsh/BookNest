...
-- Dumping data for table booknest.books: ~2 rows (approximately)
...
INSERT INTO `books` (`ID`, `TITLE`, `DESCRIPTION`, `AUTHOR`, `LANGUAGE`, `AGE_GROUP`, `COVER`, `FILE_PATH`, `IS_ACTIVE`, `CREATED_DATE`) VALUES
	(13, 'Book Two', 'This Book Two for Test and Enjoy with Children', 'Omar', 'English', '10-12', 'assets/books/images/cover_69318470bfb49.jpg', 'assets/books/files/book_69318470bfd4a.pdf', 'Y', '2025-12-04 14:54:08');
INSERT INTO `books` (`ID`, `TITLE`, `DESCRIPTION`, `AUTHOR`, `LANGUAGE`, `AGE_GROUP`, `COVER`, `FILE_PATH`, `IS_ACTIVE`, `CREATED_DATE`) VALUES
...
INSERT INTO `books` (`ID`, `TITLE`, `DESCRIPTION`, `AUTHOR`, `LANGUAGE`, `AGE_GROUP`, `COVER`, `FILE_PATH`, `IS_ACTIVE`, `CREATED_DATE`) VALUES
	(15, 'Book Four', ' 729532729532729532729532', 'Mohamed Osama', 'French', '4-6', 'assets/books/images/cover_693345e9a280d.png', 'assets/books/files/book_693345e9a2d1d.pdf', 'Y', '2025-12-05 22:51:53');
...
-- Dumping data for table booknest.children: ~1 rows (approximately)
...
INSERT INTO `children` (`ID`, `CODE`, `NAME`, `DOB`, `AGE`, `AVATER`, `CREADTED_DATE`, `USER_ID`, `ROLE_ID`) VALUES
	(8, 'CHILD-18-813981', 'Karem', '2021-02-01', '4', NULL, '2025-12-05 22:38:10', 18, 4);
...
-- Dumping data for table booknest.favorites: ~2 rows (approximately)
INSERT INTO `favorites` (`ID`, `CREATED_DATE`, `USER_ID`, `BOOK_ID`) VALUES
	(24, '2025-12-05 18:57:22', 1, 13);
INSERT INTO `favorites` (`ID`, `CREATED_DATE`, `USER_ID`, `BOOK_ID`) VALUES
	(25, '2025-12-05 20:04:51', 2, 13);
...
-- Dumping data for table booknest.options: ~34 rows (approximately)
...
-- Dumping data for table booknest.questions: ~9 rows (approximately)
...
INSERT INTO `questions` (`ID`, `QUESTION`, `TYPE`, `CREATED_DATE`, `QUIZ_ID`) VALUES
	(12, 'Question 1', 'multiple_choice', '2025-12-05 19:57:36', 5);
INSERT INTO `questions` (`ID`, `QUESTION`, `TYPE`, `CREATED_DATE`, `QUIZ_ID`) VALUES
	(13, 'Q1', 'multiple_choice', '2025-12-05 22:54:06', 6);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Collect all quizzes';

-- Dumping data for table booknest.quizzes: ~5 rows (approximately)
...
INSERT INTO `quizzes` (`ID`, `TITLE`, `DESCRIPTION`, `CREATED_DATE`, `USER_ID`, `BOOK_ID`) VALUES
	(5, 'Quiz 1', 'THes', '2025-12-05 19:57:36', 2, 12);
INSERT INTO `quizzes` (`ID`, `TITLE`, `DESCRIPTION`, `CREATED_DATE`, `USER_ID`, `BOOK_ID`) VALUES
	(6, 'Quiz Book Four', 'Thest idsf', '2025-12-05 22:54:06', 2, 15);
...
INSERT INTO `scores` (`ID`, `CHILD_ID`, `QUIZ_ID`, `SCORE_PERCENTAGE`, `TOTAL_QUESTIONS`, `CORRECT_ANSWERS`, `DATE_COMPLETED`) VALUES
	(23, 6, 5, 0.00, 1, 0, '2025-12-05 20:49:41');
INSERT INTO `scores` (`ID`, `CHILD_ID`, `QUIZ_ID`, `SCORE_PERCENTAGE`, `TOTAL_QUESTIONS`, `CORRECT_ANSWERS`, `DATE_COMPLETED`) VALUES
	(24, 6, 2, 0.00, 3, 0, '2025-12-05 20:50:53');
INSERT INTO `scores` (`ID`, `CHILD_ID`, `QUIZ_ID`, `SCORE_PERCENTAGE`, `TOTAL_QUESTIONS`, `CORRECT_ANSWERS`, `DATE_COMPLETED`) VALUES
	(25, 8, 3, 66.67, 3, 2, '2025-12-05 22:45:22');
INSERT INTO `scores` (`ID`, `CHILD_ID`, `QUIZ_ID`, `SCORE_PERCENTAGE`, `TOTAL_QUESTIONS`, `CORRECT_ANSWERS`, `DATE_COMPLETED`) VALUES
	(26, 8, 6, 100.00, 1, 1, '2025-12-05 22:56:14');
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='These users for booknest website';
...
INSERT INTO `users` (`ID`, `FIRST_NAME`, `LAST_NAME`, `USERNAME`, `PASSWORD`, `PASSKEY`, `PHONE`, `IS_SUBSCRIBED`, `CREATED_DATE`, `ROLE_ID`) VALUES
	(1, 'Admin', 'BookNest', 'admin@gmail.com', '$2y$10$9U7SjlvjVqOIwE/13LA5P.5d3TyXYpedTX7RWSuRECsGm.mII8yai', NULL, '0123456789', 'Y', '2025-11-22 23:27:54', 1);
INSERT INTO `users` (`ID`, `FIRST_NAME`, `LAST_NAME`, `USERNAME`, `PASSWORD`, `PASSKEY`, `PHONE`, `IS_SUBSCRIBED`, `CREATED_DATE`, `ROLE_ID`) VALUES
...
INSERT INTO `users` (`ID`, `FIRST_NAME`, `LAST_NAME`, `USERNAME`, `PASSWORD`, `PASSKEY`, `PHONE`, `IS_SUBSCRIBED`, `CREATED_DATE`, `ROLE_ID`) VALUES
	(18, 'Mohamed', 'Ahmed', 'Ma@gmail.com', '$2y$10$RYMpzo0igFljmVKjECxwX.HsAZJThBWY8j2BcXyEtjjM3jKJNT8YS', 729532, '2987829099', 'Y', '2025-12-05 22:34:22', 3);
